...
public class AvrConditionDisplay implements Observer, DisplayElement {
    ...
    public AvrConditionDisplay(Subject weatherData) {
    ...
    @Override
    public void display() {
        System.out.println("平均气温为：" + weatherInfo.temperature);
    }
}
